    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Read our latest blog posts about real estate, property development, and industry insights."
          />
        </Helmet>
        <div className="max-w-5xl mx-auto p-6 min-h-screen pt-32">
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the latest trends, tips, and insights in real estate. Read expert articles about property investment, home buying, and market analysis."
        />
        <meta
          name="keywords"
          content="real estate blog, property blog, real estate tips, property investment, home buying guide"
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-green-700 to-blue-700 text-white py-16 pt-32">
          <div className="max-w-5xl mx-auto px-6">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Three Leaf World Blog
            </h1>
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl">
              Stay updated with the latest insights, trends, and expert advice in
              real estate
            </p>
          </div>
        </div>
